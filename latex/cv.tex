...
\newcommand{\myhello}{"/home/kavi/Pictures/meprof"} 
%\Header{name}{email}{phone}{city}{country}{motivation}{[picture]}
\newcommand{\Header}[7]{
	\MyName{#1}
	\vskip 15pt
	\PersonalEntry{github}{​\texttt{github.com/jayathungek}}\\
	\PersonalEntry{e-mail}{\texttt{#2}}\\
	\PersonalEntry{phone}{​\texttt{#3}}\\
	\AddressEntry{#4}{#5}

	\edef\mytemp{{#7}}%
	\expandafter\ifstrequal\mytemp{none}{}{\placepicture[north east]{0.9}{0.98}{#7}}
	\vskip 15pt
	\MySlogan{#6}
}

\newcommand{\CompLen}[2]{
  \StrLen{#1}[\MyStrLen]% find the length of the string and store it in \MyStrLen
  \ifthenelse{\equal{\MyStrLen}{#2}} {TRUE} {FALSE}
}
...
\begin{document}
	...
	table = JSON:decode(read("parameters.json"))
    \end{luacode}

\Header{Kavisha Jayathunge}
	   {​jayathunge.work@gmail.com}
	   {(+971)524828855}
